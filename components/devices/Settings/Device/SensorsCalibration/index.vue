...
interface DevicesSettingsDeviceSensorsCalibrationFormModelInterface {
  values: { [key: string]: any }
}

interface DevicesSettingsDeviceSensorsCalibrationFormInterface {
  model: DevicesSettingsDeviceSensorsCalibrationFormModelInterface,
...
export default defineComponent({
  ...
  setup(props: DevicesSettingsDeviceSensorsCalibrationPropsInterface, context: SetupContext) {
    ...
    async function submit(event?: MouseEvent): Promise<void> {
      ...
      const errorMessage = context.root.$t('devices.messages.calibrationFailed', {
        device: props.device.title,
      }).toString()
