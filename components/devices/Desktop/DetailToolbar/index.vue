<template>
  <desktop-detail-toolbar class="fb-devices-desktop-detail-toolbar__container">
    <template slot="left">
      <fb-ui-button
    ...
    <template slot="right">
      <i18n
        ...
        tag="div"
        class="fb-devices-desktop-detail-toolbar__paging"
      >
        <span
          slot="page"
          class="fb-devices-desktop-detail-toolbar__paging-page"
        >
          {{ page }}
        </span>
        <span
          slot="total"
          class="fb-devices-desktop-detail-toolbar__paging-total"
        >
          {{ total }}
        </span>
      </i18n>
...
export default defineComponent({
  ...
  name: 'DevicesDesktopDetailToolbar',
