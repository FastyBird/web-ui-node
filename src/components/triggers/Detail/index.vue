  ...
  export default {
    ...
    methods: {
      ...
      conditionType(condition) {
        if (condition.type === TRIGGERS_CONDITION_THING_PROPERTY) {
          return 'TriggersDetailConditionThingProperty'
        } else if (condition.type === TRIGGERS_CONDITION_CHANNEL_PROPERTY) {
       ...
       */
      actionType(action) {
        if (action.type === TRIGGERS_ACTION_CHANNEL_PROPERTY) {
      ...
      notificationType(notification) {
        if (
          notification.type === TRIGGERS_NOTIFICATION_EMAIL
          || notification.type === TRIGGERS_NOTIFICATION_CUSTOM_EMAIL
        ) {
          return 'TriggersDetailNotificationEmail'
        } else if (notification.type === TRIGGERS_NOTIFICATION_SMS) {
